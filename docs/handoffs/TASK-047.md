...
设计提交`b250b3b544e3e4da08740251aeee56b118259b1a`：计算32/32、仓库／范围0 errors、工具33/33通过；完整结果见[报告](../qa/TASK-047/REPORT.md)。UE未运行。任务Blocked登记R11／R13／R14待Owner批准；不把本次“继续047”解释为批准这些新玩法。确认后沿047扩展经批准的代码／数据／保存接口范围施工，不跳号。没有Agent合并main或自批PR权限。
...
Owner已批准047设计并授权施工、提交推送；任务Active。复用codex/TASK-047-equipment-recipes独立工作树，范围扩至Source/Hearthward、Resources/Data、Resources/UI及公共库存／保存契约。前述待批准状态与设计验证只描述前轮。
