...
核对日期：2026-09-26。当前核对主干为 `origin/main@dbba6d052b7e08e612d858ca07fc87e90dae5840`，PR #46已合入043批准文档和044生存实现，PR #47已合入045战斗实现，PR #48已合入046营地经济；以下旧审计与发行证据保留各自SHA。这里记录该主干可确认的实现和各版本已有证据；当前任务归属以任务分支快照、交接和调度者确认核对，GitHub Issue 可选。逐项来源与待办见 [TASK-041 基线与验收账本](planning/TASK-041-baseline-ledger.md)。
...
043产品规则已批准，044／045实现已合入main。当前按canonical047推进，原稿049对应本单。此前误开的052独立保留，没有引入当前基线。
...
独立分支codex/TASK-047-equipment-recipes基于上述主干。完成60级逐级表、29技能追溯、62项物品、49配方、38件有耐久装备的维修基准、独立实例迁移和双方容量方案。D1—D6均为PROPOSED，R11/R13/R14保持OPEN，待Owner批准；没有沿用原型数值的隐式批准。候选检查32/32通过，UE构建／PIE未运行；详见[047报告](qa/TASK-047/REPORT.md)。自然资源／奖励地点仍需后续内容布置，不把可计算取得链当成游戏已可取得。
