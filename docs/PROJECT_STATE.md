...
更新：2026-09-18。TASK-003、005至012已提交推送；TASK-004仅任务单、未执行。TASK-013本地模型已提交推送；当前TASK-014新增独立灰盒场，六个资产和两轮PIE28项检查已完成。
...
| 当前分支 | codex/TASK-014-graybox-validation；基于d3d0fd9853b63d7c10fe4b678a6aaf3023d66667堆叠开发，尚未合并main |
...
| 仓库检查 | TASK-013工具自测31/31通过；旧基线013范围为存档，正式范围检查33项OUT_OF_SCOPE，当前用户改派范围另行核对 |
...
| TASK-014 | 独立地图、方块网格和四种材质；项目资产引用闭包六项，移动/碰撞/坡道/门洞/暂停28项PIE检查通过；干净克隆验证见交接，第二真人尚未参与 |
