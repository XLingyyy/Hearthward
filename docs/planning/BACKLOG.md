...
| [TASK-028](../tasks/TASK-028.md) | 建筑、物品、武器、防具等3D资产导入与真实游戏应用 | 003/020/022/026既有成果；角色挂接协调027，004素材逐件复用 | Active：任务分支已导入15件静态模型并接入营地房屋、设施及临时斧头外观；防具素材、027最终接口和整单验收仍缺 |
