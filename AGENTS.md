...
- TASK-003、TASK-005至TASK-012已提交推送；TASK-004仅任务单，明确不执行。TASK-013本地模型和设计修订已提交推送。TASK-014独立灰盒已提交推送。TASK-015伙伴UI已提交推送。TASK-016世界知识快照已提交推送。TASK-017存档UI及交接已提交推送。TASK-018玩家采集/入库已提交推送。用户当前授权自行拆解并推进TASK-019营地仓储数量选择与双向存取，包含实现、验证、提交和推送任务分支；允许路径/验收见019任务单，未授权合并。仅显式非Shipping夹具，不把R22未定边界补成正式玩法。
