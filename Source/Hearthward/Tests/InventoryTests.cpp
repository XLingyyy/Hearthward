...
bool FInventoryCapacityTest::RunTest(const FString& Parameters)
{
    ...
    TestEqual(TEXT("2000 arrows exactly fill the bag"), Arrows.GetWeightHundredths(), int64(10000));
...
bool FInventoryFailureTest::RunTest(const FString& Parameters)
{
    ...
    TestEqual(TEXT("All failures preserve original weight"), Inventory.GetWeightHundredths(), int64(2000));
    ...
    TestEqual(TEXT("Empty weight restored"), Inventory.GetWeightHundredths(), int64(0));
