...
安全食物物种／自然地图源点、正式营救与故乡胜利关卡由后续内容任务接入；目前提供真实回调和有限源点接口，测试采用明确夹具。四人基本生活的预算尚不等于自然地图已可完成该循环。设施复用现有模型，高级装备／菜单未擅自配表。当前构建、原生及PIE验证结果以[046报告](docs/qa/TASK-046/REPORT.md)为准。
