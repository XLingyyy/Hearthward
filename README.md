...
[TASK-044 生存与救援设计](docs/tasks/TASK-044.md)已提交[六组候选决定及22项纸面案例](docs/design/DSGN-R04-survival-recovery.md)，覆盖饱食／回血、药品费用、耐力与暂停、倒地／环境伤害、伙伴救援和同时间结算。**新增方案尚待Owner确认，本分支不修改玩法代码。** 043已批准子范围继续生效，052提前施工成果不进入当前设计分支。
