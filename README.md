...
[战斗／潜入候选设计](docs/design/DSGN-R06-combat-stealth.md)与[契约](docs/contracts/CT-TASK-045-combat-alert.md)已整理为六组可确认方案，包含动作窗口、部位防御和20项验收输入。D1—D6尚待Owner批准，未改运行时代码或正式数值；已批准的击晕等效击杀保持有效。后续执行入口为[045任务单](docs/tasks/TASK-045.md)。
