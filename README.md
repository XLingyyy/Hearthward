...
当前分支包含 TASK-012 伙伴委托、TASK-013 本地模型接入，TASK-014 独立灰盒验证场景、TASK-015 背包/伙伴UI、TASK-016 世界/知识快照及 TASK-017 存档管理/退出确认。017实现与验证已完成，并按用户明确授权提交推送任务分支；此前成果已推送，均未合并到 `main`，完整游戏和打包验收未完成。
