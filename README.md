...
当前 PR 基线 `codex/ai-npc-stack-pr` 在最新 main 上整理 TASK-027→031 AI NPC 栈；其后本地 [TASK-032](docs/tasks/TASK-032.md) 已完成 adaptive replanning / recovery，[TASK-033](docs/tasks/TASK-033.md) 已完成 provenance-aware Belief / Knowledge State，[TASK-034](docs/tasks/TASK-034.md) 已完成 event-driven Initiative，[TASK-035](docs/tasks/TASK-035.md) 已完成 grounded Episode Memory，[TASK-036](docs/tasks/TASK-036.md) 已完成 Protect / Regroup 战斗协作，[TASK-037](docs/tasks/TASK-037.md) 已完成长期协作 Coordination Prior，[TASK-038](docs/tasks/TASK-038.md) 已完成营地自主 Routine；[TASK-039](docs/tasks/TASK-039.md) 已完成 AI NPC 组件化收口，将导航、主动消息队列、伙伴行为编排与本地模型 Runtime 从三个热点大类中抽成可复用深模块。地图与 AI 两条车道保持隔离；不把 TASK-026 视为已完成视觉验收。见 [026世界状态](docs/world/TASK-026/CURRENT.md) 与各 AI 任务交接。
